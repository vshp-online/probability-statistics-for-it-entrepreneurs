...
meta = {
    ...
    "book_ref": "Раздел 1.2 / Рисунок 1.6",
    "description": "Диаграмма Венна для пересечения событий A и B",
    "authors": [
...
def draw(ax):
    """Диаграмма: пересечение событий A и B с заливкой только пересекающейся области."""
    ...
    # Заливка пересечения
    patch = shape_to_patch(inter, facecolor='lightblue', edgecolor='none')
