meta = {
    "title": "Совместные события A и B",
    "book_ref": "Пример 1.17 / Рисунок 1.6",
    "description": "Пример диаграммы Венна для совместных событий A и B",
    "authors": [
...
def draw(ax):
    ...
    a = ellipse_as_shapely(2, 2, 2.4, 1.6)
    b = ellipse_as_shapely(4, 2, 2.4, 1.6)
    u = unary_union([a, b])
